...
void Terrain3DTextureAsset::set_ao_light_effect(const real_t p_ao_light_effect) {
	SET_IF_DIFF(_ao_light_effect, CLAMP(p_ao_light_effect, 0.0f, 1.0f));
...
void Terrain3DTextureAsset::_bind_methods() {
	...
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "ao_light_effect", PROPERTY_HINT_RANGE, "0.0, 1.0"), "set_ao_light_effect", "get_ao_light_effect");
