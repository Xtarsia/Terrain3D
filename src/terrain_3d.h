...
public:
	...
	void set_show_turbulence(const bool p_enabled) { _material.is_valid() ? _material->set_show_turbulence(p_enabled) : void(); }
	bool get_show_turbulence() const { return _material.is_valid() ? _material->get_show_turbulence() : false; }
